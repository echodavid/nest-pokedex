...
export class PokemonService {
  constructor(
    ...
    private readonly pokemonModel: Model<Pokemon>, //por si solo no es un servicio, no es inyectable
  ) {}
  ...
  private handleExeption (error: any) {
    ...
    console.log(error);
    throw new InternalServerErrorException('Error creating pokemon - check logs');
  }
}
